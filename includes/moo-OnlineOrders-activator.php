...
*/
        $wpdb->query("CREATE TABLE IF NOT EXISTS `{$wpdb->prefix}moo_item` (
                      ...
                      `featured` INT(1) NULL DEFAULT 0,
                      `outofstock` INT(1) NOT NULL DEFAULT 0,
                      `sort_order` INT NULL ,
                      `category_uuid` VARCHAR(100) NULL ,
...
*/
        $wpdb->query("CREATE TABLE IF NOT EXISTS `{$wpdb->prefix}moo_category` (
                      ...
                      `items_imported` INT(1) NOT NULL DEFAULT 0 ,
                      `items` TEXT NULL ,
...
*/
        ...
        $wpdb->query("CREATE TABLE IF NOT EXISTS `{$wpdb->prefix}moo_modifier` (
                      ...
                      `is_pre_selected` INT(1) NULL DEFAULT 0,
...
*/
        ...
        */
        $wpdb->query("CREATE TABLE IF NOT EXISTS `{$wpdb->prefix}moo_order_types` (
                          ...
                          `allow_service_fee` INT(1) NULL DEFAULT 1 ,
        ...
        */
        ...
        $wpdb->query("CREATE TABLE IF NOT EXISTS `{$wpdb->prefix}moo_items_categories` (
                          ...
                          CONSTRAINT `{$wpdb->prefix}fk_category_has_items`
                            ...
                            ON DELETE CASCADE
                            ON UPDATE CASCADE,
                            UNIQUE(`item_uuid`,`category_uuid`)) DEFAULT CHARACTER SET $wpdb->charset;");
        // Add the page :
        $pages = array(
            'store'=>array(
